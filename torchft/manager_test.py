...
from torchft._torchft import QuorumResult, FailureStream, LighthouseClient, LighthouseServer
from torchft.checkpointing.transport import CheckpointTransport
from torchft.manager import MANAGER_ADDR_KEY, REPLICA_ID_KEY, Manager, WorldSizeMode, ExceptionWithTraceback, _failure_listener_process_main
from torchft.process_group import ProcessGroup, _DummyWork, ProcessGroupGloo
...
class TestManager(TestCase):
    ...
    def test_direct_error_pipe(self) -> None:
        ...
        self.assertIsNotNone(error_obj, "Error should have been captured by the Manager")
    ...
    def test_manager_failure_e2e(self) -> None:
        ...
        self.assertIn(failed_replica_id, str(error_obj.original_exception), 
